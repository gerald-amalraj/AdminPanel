...
public class LongLatService {
	...
	public static void main(String[] args) throws Exception {
		...
		tDirectionService.getLongitudeLatitude("Coimbatore, Tamil Nadu, India");
	}

	public static UtilsBean getLongitudeLatitude(String address) {
		
		UtilsBean utilBean = new UtilsBean();
		try {
			...
			try {
				...
				utilBean.setLatitude(Double.parseDouble(strLatitude));
				...
				utilBean.setLongitude(Double.parseDouble(strLongtitude));
			} finally {
